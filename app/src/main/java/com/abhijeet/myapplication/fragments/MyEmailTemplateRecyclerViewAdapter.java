...
import com.abhijeet.myapplication.fragments.EmailTemplateListFragment.OnListFragmentInteractionListener;
...
public class MyEmailTemplateRecyclerViewAdapter extends RecyclerView.Adapter<MyEmailTemplateRecyclerViewAdapter.ViewHolder> {
    ...
    public MyEmailTemplateRecyclerViewAdapter(List<DummyItem> items, OnListFragmentInteractionListener listener) {
        mValues = items;
        mListener = listener;
    }
